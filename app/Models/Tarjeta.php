...
class Tarjeta extends Model
{
    ...
    protected $fillable = [
        'pagina', 'orden', 'title', 'subtitulo', 'url_clean', 'content', 'posted', 'category_id', 'created_at', 'updated_at'
    ];
    ...
    public function images(){
        return $this->belongsToMany(Image::class,'image_tarjeta', 'tarjeta_id', 'image_id')->withTimestamps();
    }
