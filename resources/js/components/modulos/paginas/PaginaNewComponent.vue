...
<div>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-start">
            <div class="ml-3 mb-5 titulo-listas subrayar-verde"><span v-bind:style="{ color: ds_admin[2].linea }">P</span>ágina Nueva</div>
            <spinner-component :spinner="spinner"></spinner-component>
        </div>

        <!--Card content-->
        <div class="card-body px-lg-5 pt-5 fondo-principal text-white">
            ...
            <form class="text-left" @submit.prevent="submit">
                ...
                <!--Content-->
                <label class="font-weight-bold text-white mt-2">Descripción</label>
