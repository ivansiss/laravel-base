    ...
    <div class="card card-body mb-3 mt-5 z-depth-4" :style="{ backgroundColor: ds_admin[4].backgroundColor, color:ds_admin[4].color }">
        ...
        <div class="media d-block d-md-flex mb-5">
            <div class="media-body text-center text-md-left ml-md-3 ml-0">
                <div class="mt-0 d-flex justify-content-end mr-4" :style="{ color:ds_admin[4].texto }" v-html="'Actualizado: ' + pag.fecha_formateada">
                </div>
                <img class="mb-3 mr-3 img-fluid float-left" v-if="pag.title" id="foto2" v-bind:src=" '/storage/imagenes/web_engranajes.png'" alt="Generic placeholder image" width="50px">
                <h3 class="mt-0 font-weight-bold shadow" :style="{ color: ds_admin[4].linea,borderBottom: ds_admin[4].border }" v-html="pag.title"></h3>
                <h5 class="mt-0" :style="{ color:ds_admin[4].texto }" v-html="pag.subtitulo"></h5>
                <br>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-2" v-for="p in pag['images']" :key="p.id">
