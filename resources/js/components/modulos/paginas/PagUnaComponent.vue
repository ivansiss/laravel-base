        ...
        <div class="card card-body mb-3 mt-5 z-depth-4 bg-puente" :style="{ backgroundColor: ds_admin[12].backgroundColor, color:ds_admin[12].color }">
            ...
            <div class="media d-block d-md-flex mb-5">
                <div class="media-body text-center text-md-left ml-md-3 ml-0">
                    ...
                    <div v-if="pag.title !='' || pag.subtitulo !='' || pag.content !=''">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 mb-3 d-flex justify-content-center" v-if="pag['images'].length">
                        <img class="mb-3 mr-3 rounded img-fluid z-depth-3"  id="foto1" v-bind:src=" '/storage/imagenes/' + pag['images'][0].image" alt="Generic placeholder image" width="945px">
                    </div>
                </div>
