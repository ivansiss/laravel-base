        ...
        <div class="card card-body mb-3 mt-5 z-depth-4" :style="{ backgroundColor: ds_admin[4].backgroundColor, color:ds_admin[4].color }">
            ...
            <div class="media d-block d-md-flex">
                ...
                <div class="media-body text-center text-md-left ml-md-3 ml-0">
                    ...
                    <div class="mt-0 d-flex justify-content-end mr-4" :style="{ color:ds_admin[4].texto }" v-html="'Actualizado: ' + post.fecha_formateada"></div>
                    ...
                    <h5 class="mt-0" v-html="post.subtitulo" :style="{ color:ds_admin[4].texto }"></h5>
